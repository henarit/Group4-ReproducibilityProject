...
OUTPKL = f"results/{MULTIMODAL}_mirna_clinical_gene.pkl"
print (OUTFILE)
...
class Network(TrainableModel):
    ...
    def forward(self, data, mask):
        ...
        x = F.dropout(x, 0.4) # why 0.4? /Johan
        ...
        # z = F.tanh(self.fcg(z)) # ... deprecated
        # ==== NEW ====
...
if __name__ == "__main__":
  ...
  model.save(f"results/predict3_{MULTIMODAL}.pth")
